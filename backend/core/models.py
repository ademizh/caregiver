...
class Address(models.Model):
    # В исходной схеме PK составной, но в Django сделаем отдельный id + unique_together
...
class Job(models.Model):
    ...
    required_caregiving_type = models.CharField(
        max_length=20,
        choices=CAREGIVING_TYPE_CHOICES,
    )
    ...
    def __str__(self):
        return f"Job {self.job_id} for {self.member.member_user.given_name}"
